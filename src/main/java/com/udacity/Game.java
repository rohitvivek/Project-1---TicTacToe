...
public class Game {
    ...
    public String checkGameWinner(char[][] grid) {
        ...
        //checks for horizontal O's

        else if (grid[0][0] == 'o' && grid[1][0] == 'x' && grid[2][0] == 'x') {
            return result = "O wins";
        ...
        //checks if the grid is filled in
